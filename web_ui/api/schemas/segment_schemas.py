...
class SegmentCreate(BaseModel):
    ...
    voice_sample_id: Optional[str] = None  # Voice cloning (Coqui TTS only)
    tts_provider: Optional[str] = None  # TTS provider (edge_tts, coqui, piper, etc.)
...
class SegmentResponse(BaseModel):
    ...
    voice_id: str
    voice_sample_id: Optional[str] = None  # Voice cloning (Coqui TTS only)
    tts_provider: Optional[str] = None  # TTS provider used for audio generation
    rate: str
    volume: str
    pitch: str
