...
class VideoInfo(BaseModel):
    ...
    source_start: float = 0.0  # Where to start reading from source video
    source_end: Optional[float] = None  # Where to stop reading (None = full duration)
...
class BGMTrackInfo(BaseModel):
    ...
    audio_offset: float = 0.0  # Offset into audio file for start trimming
...
class UpdateBGMTrackRequest(BaseModel):
    ...
    audio_offset: Optional[float] = None  # Offset into audio file for start trimming
...
class UpdateVideoPositionRequest(BaseModel):
    """Request to update video timeline position"""
    timeline_start: Optional[float] = None
    timeline_end: Optional[float] = None
