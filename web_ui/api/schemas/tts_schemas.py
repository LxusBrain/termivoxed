...
class TTSGenerateRequest(BaseModel):
    ...
    # Voice cloning parameters (Coqui TTS only)
    voice_sample_id: Optional[str] = None  # If set, use voice cloning
    additional_sample_ids: Optional[List[str]] = None  # Additional samples for better quality
